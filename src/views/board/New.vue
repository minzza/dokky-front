  ...
  <v-sheet>
    <div class="pa-6">
      ...
      <div class="text-body-2 text-grey">
        <strong>{{ name }}</strong
        >님 지식공유 플랫폼 DOKKY에서 다양한 사람을 만나고 생각의 폭을
        넓혀보세요.
      </div>
    </div>
    ...
    <v-form ref="form">
      <v-container>
        <v-select :items="topics" label="토픽" variant="outlined"></v-select>

        <v-text-field label="제목" variant="outlined"></v-text-field>
